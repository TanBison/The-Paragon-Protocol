...
and this is the third one and im hopeful for it.

the first ever attempt was under a project that was called ProjectZ and that attempt was nothing but a suffer, an unreadable one file only code full of
...
does it evaluate a form and how does it evaluate but im still working on it right now and anything i say might be changed so i will leave the talk about the model
to when its ready.
